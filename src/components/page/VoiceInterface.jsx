...
//       <h2 className="text-xl font-bold mb-4 text-indigo-800">Restaurant Voice Assistant</h2>
...
//           <div className="bg-indigo-50 rounded-lg p-3 text-sm text-indigo-700">"Show me Italian restaurants nearby"</div>
//           <div className="bg-indigo-50 rounded-lg p-3 text-sm text-indigo-700">"What's the highest rated restaurant?"</div>
//           <div className="bg-indigo-50 rounded-lg p-3 text-sm text-indigo-700">"Tell me about [Restaurant Name]"</div>
//           <div className="bg-indigo-50 rounded-lg p-3 text-sm text-indigo-700">"I'm looking for Mexican food"</div>
//         </div>
//       </div>
...
//           <input
//             type="text"
//             className="flex-1 border border-gray-300 rounded-l-lg p-3 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
//             value={query}
...
//           <p className="text-indigo-700 italic">"{query}"</p>
//         </div>
//       )}
...
//           <div className="flex items-center">
//             <div className="w-16 h-16 bg-gray-300 rounded-lg mr-3" style={{
//               backgroundImage: `url('/api/placeholder/200/200')`,
//               backgroundSize: 'cover',
//               backgroundPosition: 'center'
//             }}></div>
//             <div>
//               <h3 className="font-bold text-lg text-indigo-800">{selectedRestaurant.name}</h3>
//               <div className="flex items-center mt-1">
//                 <span className="text-yellow-500">★</span>
//                 <span className="ml-1 text-gray-700">{selectedRestaurant.


// Inside the VoiceInterface component
return (
